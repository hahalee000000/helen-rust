...
fn free_vars_simple_capture() {
    ...
    let lambda = make_lambda(
        vec!["x"],
        vec![make_expr_stmt(Expr::Binary(Binary {
...
fn free_vars_unary_expression() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Unary(Unary {
            operator: dummy_token(),
...
fn free_vars_call_expression() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Call(Call {
...
fn free_vars_index_expression() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Index(Index {
...
fn free_vars_list_literal() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::List(ListLit {
...
fn free_vars_map_literal() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Map(MapLit {
...
fn free_vars_access_expression() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Access(Access {
...
fn free_vars_grouping_expression() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Grouping(Grouping {
...
fn free_vars_pipe_expression() {
    ...
    let lambda = make_lambda(
        vec![],
        vec![make_expr_stmt(Expr::Pipe(Pipe {
